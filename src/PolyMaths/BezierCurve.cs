...
namespace PolyMaths.Algorithms
{
    ...
    public class BezierCurve
    {
        ...
        // [Correctif intégration] Degré basé sur la liste réellement remplie :
        // EvaluateDirect3D / RebuildPascal s'appuient sur Degree, mais une
        // courbe 3D n'alimente que _controlPoints3D (via AddPoint3D). Sans ce
        // correctif, Degree valait -1 et la surface "directe" s'effondrait à 0.
        public int  Degree => (_controlPoints3D.Count > 0 ? _controlPoints3D.Count : _controlPoints2D.Count) - 1;
